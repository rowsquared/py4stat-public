# Household Living Conditions and Connectivity — Census 2022 (Solution)

## 1. What this is

This folder is the **completed solution**: two Jupyter notebooks with every blank
filled in. It renders to an HTML report end to end with no edits. The companion
`reports/` folder is the student exercise, with blanks to complete.
